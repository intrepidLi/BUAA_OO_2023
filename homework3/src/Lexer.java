public class Lexer {
    ...
    private void nextTri(String s) {
        curToken = s;
        isOperator = false;
    }

    private void nextDif(String s) {
        curToken = s;
        isOperator = false;
    }
    ...
    public void next() {
        ...
        if (Character.isDigit(c)) {
            ...
            pos += 3;
            String str = "d" + input.charAt(pos - 2) + "(";
            nextDif(str);
    ...
    public static String deleteMulAddProcess(String str) { //将**和*后的+号删掉
        StringBuilder sb = new StringBuilder();
